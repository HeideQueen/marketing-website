    ...
    <main className={styles.featureContainer}>
      ...
      <section className={styles.imageFeature}>
        ...
        <aside className={styles.imageTextContainer}>
          <p>
            ...
            messenger bag. Kinfolk bespoke whatever, pop-up farm-to-table squid
            distillery live-edge prism. Umami pour-over af pok pok brooklyn twee
            pickled
          </p>
        </aside>
      </section>
      <section className={styles.listContainer}>
        ...
        <ul>
          ...
          <li>
            Narwhal hexagon sriracha next level affogato paleo fam hell of venmo
            semiotics glossier meh ethical VHS meggings.
          </li>
          <li>Sriracha schlitz shaman unicorn helvetica.</li>
          <li>
            Shoreditch mlkshk marfa prism vaporware vinyl chambray health goth.{' '}
          </li>
          <li>
